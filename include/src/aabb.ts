...
import { b2AABB, b2Vec2, b2IsValidVec2, b2Sub } from "../box2d/math_functions.ts";

export function b2IsValidAABB(a: b2AABB): boolean
{
	const d: b2Vec2 = b2Sub(a.upperBound, a.lowerBound);
	let valid: boolean = d.x >= 0 && d.y >= 0;
